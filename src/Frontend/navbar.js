function navbar() {
    ...
    <div id="navbar_container">
        ...
        <a href="index.html"><img src="./images/navporter_logo.png" alt=""></a>
            ...
            <div >
                <p id="nav_heading">Indias's most trusted logistics brand</p>
            </div>
        </div>
        <div id="nav_right">
            <div id="drive-us">
                ...
                <div id="drive-heading">
                    <p id="drive_title">Join as a driver</p>
                    <p id="drive_desc">Grow with Us</p>
                </div>
                <div id="join-us">
                    <p >JOIN US</p>
                </div>
